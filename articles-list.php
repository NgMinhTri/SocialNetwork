          ...
          <div class="span8 main-listing">
            <article class="format-standard type-post hentry clearfix">
              ...
              <p>
                ...
                show for it. And we start the next . . .
                <a
                  class="readmore-link"
            ...
            <article class="format-standard type-post hentry clearfix">
              <header class="clearfix">
                <h3 class="post-title">
                  <a href="single.php">Using Javascript</a>
                </h3>
                ...
                <div class="post-meta clearfix">
                  ...
                  >
                  <span class="comments"
                    ><a href="#" title="Comment on Using Javascript"
                      >0 Comments</a
                    ></span
                  >
              ...
              <p>
                ...
                <a
                  class="readmore-link"
                  href="http://knowledgebase.inspirythemes.com/using-javascript/"
                  >Read more</a
                >
              </p>
            </article>
            ...
            <article class="type-post format-image hentry clearfix">
              <header class="clearfix">
                <h3 class="post-title">
                  <a href="single.php">Using Images</a>
                </h3>
                ...
                <div class="post-meta clearfix">
                  ...
                  >
                  <span class="comments"
                    ><a href="#" title="Comment on Using Images"
                      >0 Comments</a
                    ></span
                  >
              ...
              <p>
                ...
                <a
                  class="readmore-link"
                  href="http://knowledgebase.inspirythemes.com/using-images/"
                  >Read more</a
                >
              </p>
            </article>
            ...
            <article class="type-post format-video hentry clearfix">
              <header class="clearfix">
                <h3 class="post-title">
                  <a href="single.php">Using Video</a>
                </h3>
                ...
                <div class="post-meta clearfix">
                  ...
                  <span class="comments"
                    ><a href="#" title="Comment on Using Video"
                      >0 Comments</a
                    ></span
                  >
              ...
              <div class="post-video">
                <div class="video-wrapper">
                  <iframe
                    src="http://player.vimeo.com/video/24535181"
                    width="500"
                    height="281"
                    frameborder="0"
              ...
              <p>
                ...
                <a
                  class="readmore-link"
                  href="http://knowledgebase.inspirythemes.com/using-video/"
                  >Read more</a
                >
              </p>
            </article>
            ...
            <article class="type-post format-standard hentry clearfix">
              <header class="clearfix">
                ...
                <div class="post-meta clearfix">
                  ...
                  <span class="comments"
                    ><a href="#" title="Comment on WordPress Site Maintenance"
                      >0 Comments</a
                    ></span
                  >
              ...
              <p>
                ...
                <a
                  class="readmore-link"
                  href="http://knowledgebase.inspirythemes.com/wordpress-site-maintenance/"
                  >Read more</a
                >
              </p>
            </article>
