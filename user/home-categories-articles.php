        ...
        <div class="row">
          ...
          <div class="span8 page-content">
                ...
                <ul class="articles">
                  ...
                  <li class="article-entry standard">
                    ...
                    <span class="article-meta"
                      ...
                      <a
                        href="single.php"
                        title="View all posts in Website Dev"
                        >Website Dev</a
                      ></span
                    >
                  ...
                  <li class="article-entry image">
                    ...
                    <span class="article-meta"
                      ...
                      <a
                        href="single.php"
                        title="View all posts in Advanced Techniques"
                ...
                <ul class="articles">
                  ...
                  <li class="article-entry video">
                    ...
                    <span class="article-meta"
                      ...
                      <a
                        href="single.php"
                        title="View all posts in WordPress Plugins"
                        >WordPress Plugins</a
                      ></span
                    >
                    <span class="like-count">7</span>
                  ...
                  <li class="article-entry standard">
                    ...
                    <span class="article-meta"
                      ...
                      <a
                        href="single.php"
                        title="View all posts in Theme Development"
                        >Theme Development</a
                      ></span
                    >
            ...
            <div class="row separator">
              <section class="span4 articles-list">
                <h3>
                  <a href="single.php">WordPress for Beginners</a>
                  <span>(4)</span>
                </h3>
                <ul class="articles">
                  <li class="article-entry image">
                    <h4>
                      <a href="single.php"
                        >New To WordPress &#8211; Where to Start</a
                      >
                    </h4>
                    <span class="article-meta"
                      >24 Feb, 2013 in
                      <a
                        href="single.php"
                        title="View all posts in WordPress for Beginners"
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Introduction to Blogging</a></h4>
                    <span class="article-meta"
                      >23 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry image">
                    <h4>
                      <a href="single.php">First Steps With WordPress</a>
                    </h4>
                    <span class="article-meta"
                      >22 Feb, 2013 in
                      <a
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Installing WordPress</a></h4>
                    <span class="article-meta"
                      >21 Feb, 2013 in
                      <a
                        href="single.php"
              ...
              <section class="span4 articles-list">
                <h3>
                  <a href="single.php">Designing in WordPress</a>
                  <span>(4)</span>
                </h3>
                <ul class="articles">
                  <li class="article-entry image">
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Designing Headers</a></h4>
                    <span class="article-meta"
                      >23 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Formatting Date and Time</a></h4>
                    <span class="article-meta"
                      >22 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry standard">
                    <h4>
                      <a href="single.php">Developing a Colour Scheme</a>
                    </h4>
                    <span class="article-meta"
                      >21 Feb, 2013 in
                      <a
            ...
            <div class="row separator">
              <section class="span4 articles-list">
                <h3>
                  <a href="single.php">Theme Development</a> <span>(4)</span>
                </h3>
                <ul class="articles">
                  <li class="article-entry standard">
                    <h4>
                  ...
                  <li class="article-entry image">
                    <h4><a href="single.php">Stepping Into Templates</a></h4>
                    <span class="article-meta"
                      >23 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Creating Individual Pages</a></h4>
                    <span class="article-meta"
                      >22 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry image">
                    <h4><a href="single.php">Uploading Files</a></h4>
                    <span class="article-meta"
                      >21 Feb, 2013 in
                      <a
                        href="single.php"
              ...
              <section class="span4 articles-list">
                <h3><a href="single.php">Website Dev</a> <span>(4)</span></h3>
                <ul class="articles">
                  <li class="article-entry standard">
                    <h4>
                      <a href="single.php">WordPress Site Maintenance</a>
            ...
            <div class="row separator">
              <section class="span4 articles-list">
                <h3>
                  <a href="single.php">WordPress Plugins</a> <span>(4)</span>
                </h3>
                <ul class="articles">
                  <li class="article-entry video">
                    <h4><a href="single.php">Using Video</a></h4>
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Photoblogs and Galleries</a></h4>
                    <span class="article-meta"
                      >23 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry video">
                    <h4><a href="single.php">Plugin Resources</a></h4>
                    <span class="article-meta"
                      >22 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Managing Plugins</a></h4>
                    <span class="article-meta"
                      >21 Feb, 2013 in
                      <a
                        href="single.php"
              ...
              <section class="span4 articles-list">
                <h3>
                  <a href="single.php">Advanced Techniques</a> <span>(4)</span>
                </h3>
                <ul class="articles">
                  <li class="article-entry standard">
                    <h4><a href="single.php">Using Javascript</a></h4>
                  ...
                  <li class="article-entry video">
                    <h4><a href="single.php">Editing Files</a></h4>
                    <span class="article-meta"
                      >24 Feb, 2013 in
                      <a
                        href="single.php"
                  ...
                  <li class="article-entry standard">
                    <h4><a href="single.php">Importing Content</a></h4>
                    <span class="article-meta"
                      >23 Feb, 2013 in
                      <a
                        href="single.php"
