...
<form id="passwordForm">
        <input type="password" class="input-lg form-control" style="height: 37px;" name="password" id="password" placeholder="New Password" autocomplete="off">
        <div class="row">
        <div class="col-sm-6">
        ...
        <input type="password" class="input-lg form-control" style="height: 37px;" name="password2" id="password2" placeholder="Repeat Password" autocomplete="off">
        <div class="row">
        <div class="col-sm-12">
